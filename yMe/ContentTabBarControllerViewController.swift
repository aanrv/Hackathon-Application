...
class ContentTabBarControllerViewController: UITabBarController{
    ...
    init(arrControllers : [UIViewController], objectId: String){
        ...
        view1.tabBarItem = UITabBarItem(title: "Article", image: UIImage(named: "ARTICLE.png"), tag: 0)
        view2.tabBarItem = UITabBarItem(title: "Comments", image: UIImage(named: "com.png"), tag: 0)
